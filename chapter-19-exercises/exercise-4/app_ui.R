...
intro_panel <- tabPanel(
  ...
  p("this diagram shows that",em("over the last couple of decades"),"there has been a ",strong("disgusting"), "increase in income inequality in the US.")
...
sidebar_content <- sidebarPanel(
  ...
  sliderInput("percentile","Income Percentile", 0, 100, 0)
)
