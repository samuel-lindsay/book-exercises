...
employee_salaries <- runif(100, min=40000, max=50000)
...
salaries$employee_has_raise <- salaries$salary_adjustments > 0
...
#I expected the average raise to be slightly higher but thats about it
